...
export const FETCH_SHIPPING_PROVIDERS = 'fetchShippingProviders'
export const FETCH_PROVIDERS_SYNC_DIFFERENCES = 'fetchProvidersSyncDifferences'
export const PROVIDERS_SYNC = 'syncProviders'
...
export const PROVIDER_RESET_STATE = 'resetProviderState'

/* Clients CRUD */
export const FETCH_CLIENT = 'fetchClient'
export const FETCH_CLIENTS = 'fetchClients'
export const FETCH_CLIENTS_SYNC_DIFFERENCES = 'fetchClientsSyncDifferences'
export const CLIENTS_SYNC = 'syncClients'
