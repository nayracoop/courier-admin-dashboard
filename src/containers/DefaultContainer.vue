  ...
  <div class="app">
    <AppHeader fixed>
      ...
      <b-link class="navbar-brand" to="#">
        <img class="navbar-brand-full" src="/courieradmin/static/img/brand/logo.png" width="55" height="" alt="Courier Admin Logo">
        <img class="navbar-brand-minimized ml-5" src="/courieradmin/static/img/brand/logo.png" width="55" alt="Courier Admin Logo">
      </b-link>
